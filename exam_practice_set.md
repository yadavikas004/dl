...
1.  **Determinant ($|A|$):** $(1 \times 4) - (2 \times 3) = 4 - 6 = -2$.
2.  **Adjoint ($adj A$):** Swap diagonal elements, negate others $\rightarrow \begin{bmatrix} 4 & -2 \\ -3 & 1 \end{bmatrix}$.
3.  **Inverse ($A^{-1}$):** $\frac{1}{|A|} adj A = \frac{1}{-2} \begin{bmatrix} 4 & -2 \\ -3 & 1 \end{bmatrix} = \mathbf{\begin{bmatrix} -2 & 1 \\ 1.5 & -0.5 \end{bmatrix}}$.
